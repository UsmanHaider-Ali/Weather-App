  ...
  Widget build(BuildContext context) {
    return Row(
      children: [
        ...
        Expanded(child: Text(weatherData.weather[0].main, style: Theme.of(context).textTheme.bodyLarge, textAlign: TextAlign.center)),
        Expanded(
          child: Text("${kelvinToCelsius(weatherData.main.temp).toStringAsFixed(0)}\u00B0C",
